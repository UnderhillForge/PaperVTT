...
const SKY_DOME_SCRIPT: Script = preload("res://addons/sky_3d/src/SkyDome.gd")
const TIME_OF_DAY_SCRIPT: Script = preload("res://addons/sky_3d/src/TimeOfDay.gd")
