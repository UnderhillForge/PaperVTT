...
const ORBITAL_ELEMENTS_SCRIPT: Script = preload("res://addons/sky_3d/src/OrbitalElements.gd")
...
var _sun_orbital_elements: Object = ORBITAL_ELEMENTS_SCRIPT.new()
var _moon_orbital_elements: Object = ORBITAL_ELEMENTS_SCRIPT.new()
...
func _compute_realistic_sun_coords() -> void:
	...
	_sun_orbital_elements.M = TOD_MATH_SCRIPT.rev(_sun_orbital_elements.M)
...
func _compute_realistic_moon_coords() -> void:
	...
	_moon_orbital_elements.N = TOD_MATH_SCRIPT.rev(_moon_orbital_elements.N)
	_moon_orbital_elements.w = TOD_MATH_SCRIPT.rev(_moon_orbital_elements.w)
	_moon_orbital_elements.M = TOD_MATH_SCRIPT.rev(_moon_orbital_elements.M)
